...
####################################    注意：在这里修改为你的数据存放路径
path='/home/Aujust/data/Kilonova/WFST/final/' #'/Users/leilei/Documents/works/WFST/data/final/'
####################################    注意：在这里设置月相角度，只能输入0，45，90，135，180这五个数值之一，比如现在是45度
moonphase_angle=45
####################################
...
def getlim(exptime, seeing=0.75, bgsky=22.3, airmass=1.2, n_frame=1.0, sig=5.0, nu=0.0):#n_frame 帧数（次数）
    ...
    # input parameters
    eff_area  = np.pi*125**2*0.84   #cm^2    中间1m口径去掉，np.pi*50**2/(np.pi*125**2)=0.16
    ...
    return(maglm,mag_sky0,snra,mag,err,count_zero_point_filter,counts_sky_filter,fwhm_tot,pixelnum1d,pixelnum_band,counts_sky_alleff,count_zero_point_alleff) #返回极限星等

# exp = 120
# airmass = 1.5
# band_names = ['u','g','r','i']
# limmags = getlim(exp, bgsky=22.0, n_frame=1,airmass=airmass, sig=5.0)[0]
# print('{} exposure and airmass {}'.format(exp,airmass))
# for i in range(len(band_names)):
#     print(band_names[i]+' band: {:.2f}'.format(limmags[i]))
# print()
...
# print('sky   ',getlim(30, bgsky=22.0, n_frame=1,airmass=1.2, sig=3.0)[1]) #六个波段的WFST天光亮度 邓李才 V-bandSky=22.0
# print('30s   ',getlim(30, bgsky=22.0, n_frame=1,airmass=1.2, sig=3.0)[0]) #单幅图像的30s曝光极限星等 邓李才 V-bandSky=22.0
# print('3ks   ',getlim(30, bgsky=22.0, n_frame=100,airmass=1.2, sig=3.0)[0])#100幅图像的30s曝光极限星等 邓李才 V-bandSky=22.0
# print('V-band Sky: 22.3 mag, confidence level: 3 sigma')
# print('band  ',' u    ','g    ','r    ','i    ','z    ','w    ')
# #print(getlim(30,airmass=1.2))
# print('sky   ',getlim(30, bgsky=22.3, n_frame=1,airmass=1.2, sig=3.0)[1]) #六个波段的WFST天光亮度 邓李才 V-bandSky=22.0
# print('30s   ',getlim(30, bgsky=22.3, n_frame=1,airmass=1.2, sig=3.0)[0]) #单幅图像的30s曝光极限星等 邓李才 V-bandSky=22.0
# print('3ks   ',getlim(30, bgsky=22.3, n_frame=100,airmass=1.2, sig=3.0)[0])#100幅图像的30s曝光极限星等 邓李才 V-bandSky=22.0

# print('V-band Sky: 22.0 mag, confidence level: 5 sigma')
# print('band  ',' u    ','g    ','r    ','i    ','z    ','w    ')
# #print(getlim(30,airmass=1.2))
# print('sky   ',getlim(30, bgsky=22.0, n_frame=1,airmass=1.2, sig=5.0)[1]) #六个波段的WFST天光亮度 邓李才 V-bandSky=22.0
# print('30s   ',getlim(30, bgsky=22.0, n_frame=1,airmass=1.2, sig=5.0)[0]) #单幅图像的30s曝光极限星等 邓李才 V-bandSky=22.0
# print('3ks   ',getlim(30, bgsky=22.0, n_frame=100,airmass=1.2, sig=5.0)[0])#100幅图像的30s曝光极限星等 邓李才 V-bandSky=22.0
# print('V-band Sky: 22.3 mag, confidence level: 5 sigma')
# print('band  ',' u    ','g    ','r    ','i    ','z    ','w    ')
# #print(getlim(30,airmass=1.2))
# print('sky   ',getlim(30, bgsky=22.3, n_frame=1,airmass=1.2, sig=5.0)[1]) #六个波段的WFST天光亮度 邓李才 V-bandSky=22.0
# print('30s   ',getlim(30, bgsky=22.3, n_frame=1,airmass=1.2, sig=5.0)[0]) #单幅图像的30s曝光极限星等 邓李才 V-bandSky=22.0
# print('3ks   ',getlim(30, bgsky=22.3, n_frame=100,airmass=1.2, sig=5.0)[0])#100幅图像的30s曝光极限星等 邓李才 V-bandSky=22.0

# print('V-band Sky: 22.0 mag, confidence level: 10 sigma')
# print('band  ',' u    ','g    ','r    ','i    ','z    ','w    ')
# #print(getlim(30,airmass=1.2))
# print('sky   ',getlim(30, bgsky=22.0, n_frame=1,airmass=1.2, sig=10.0)[1]) #六个波段的WFST天光亮度 邓李才 V-bandSky=22.0
# print('30s   ',getlim(30, bgsky=22.0, n_frame=1,airmass=1.2, sig=10.0)[0]) #单幅图像的30s曝光极限星等 邓李才 V-bandSky=22.0
# print('3ks   ',getlim(30, bgsky=22.0, n_frame=100,airmass=1.2, sig=10.0)[0])#100幅图像的30s曝光极限星等 邓李才 V-bandSky=22.0
# print('V-band Sky: 22.3 mag, confidence level: 10 sigma')
# print('band  ',' u    ','g    ','r    ','i    ','z    ','w    ')
# #print(getlim(30,airmass=1.2))
# print('sky   ',getlim(30, bgsky=22.3, n_frame=1,airmass=1.2, sig=10.0)[1]) #六个波段的WFST天光亮度 邓李才 V-bandSky=22.0
# print('30s   ',getlim(30, bgsky=22.3, n_frame=1,airmass=1.2, sig=10.0)[0]) #单幅图像的30s曝光极限星等 邓李才 V-bandSky=22.0
# print('3ks   ',getlim(30, bgsky=22.3, n_frame=100,airmass=1.2, sig=10.0)[0])#100幅图像的30s曝光极限星等 邓李才 V-bandSky=22.0
